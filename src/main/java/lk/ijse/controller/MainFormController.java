...
public class MainFormController {
    ...
    private void changeDesignButton(JFXButton button){
        button.setStyle("-fx-background-color:   #4169E1; -fx-text-fill: #FFFFFF; -fx-border-color: #FFFFFF; -fx-border-width: 3; -fx-border-radius: 5; -fx-background-radius: 10;");
    }

    private void defaultDesignButton(){
        String style = "-fx-background-color:  #87CEFA; -fx-text-fill: #000000; -fx-border-color: #FFFFFF; -fx-border-width: 3; -fx-border-radius: 5; -fx-background-radius: 10;";
